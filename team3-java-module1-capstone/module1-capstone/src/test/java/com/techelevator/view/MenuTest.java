...
public class MenuTest {
	...
	@Test
	public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice() throws FileNotFoundException {
	...
	@Test
	public void returns_object_corresponding_to_user_choice() throws FileNotFoundException {
	...
	@Test
	public void redisplays_menu_if_user_does_not_choose_valid_option() throws FileNotFoundException {
	...
	@Test
	public void redisplays_menu_if_user_chooses_option_less_than_1() throws FileNotFoundException {
		Object[] options = new Object[] {  "Larry", "Curly", "Moe" };
	...
	@Test
	public void redisplays_menu_if_user_enters_garbage() throws FileNotFoundException {
		Object[] options = new Object[] {  "Larry", "Curly", "Moe" };
	...
	private Menu getMenuForTestingWithUserInput(String userInput) throws FileNotFoundException {
		ByteArrayInputStream input = new ByteArrayInputStream(String.valueOf(userInput).getBytes());
		return new Menu(input, output);
	}

	private Menu getMenuForTesting() throws FileNotFoundException {
